...
class PopularFollowerSerializer(serializers.ModelSerializer):
    ...
    profile_name = serializers.CharField(source='follower.profile.profile_name', default="")
    popularity_score = serializers.FloatField(source='follower.profile.popularity_score', default=0)
    ...
    def get_average_rating(self, obj):
        ...
        return Post.objects.filter(author=obj.follower).aggregate(
            Avg('average_rating')
